  ...
  template: `
    <div *ngIf="isOrganisateur; else noAccess">
      <form [formGroup]="eventForm" (ngSubmit)="onSubmit()" class="event-form">
        ...
        <button mat-raised-button color="primary" type="submit" [disabled]="eventForm.invalid">Modifier</button>
      </form>
    </div>
...
export class EventEditComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private eventService: EventService, private route: ActivatedRoute, private router: Router, private authService: AuthService) {
  ...
  ngOnInit() {
    ...
    this.route.params.pipe(
      ...
      this.eventForm.patchValue(event as Event);
    });
  }
